...
public class FrmModifierArtiste extends JDialog implements ActionListener{

	private static final long serialVersionUID = 1L;
	private JLabel labModifier, labNum, labNom, labMembre;
	private JTextField textNom, textNumero;
	private JCheckBox checkBoxMembre;
	private JPanel panel1, panel2, panel3, panel4;
	private JButton btnAjouter, btnAnnuler;
	
	public FrmModifierArtiste() {
		setTitle("Modifier l'Artiste");
		setSize(400, 200);
		setLayout(new FlowLayout());
		labModifier = new JLabel("Modifier l'Artiste!");
